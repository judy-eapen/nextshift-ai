...
def review_object(state: StudentState, obj: dict, label: str, role: str = "skeptic", batch: int = 12, repair: bool = True) -> tuple[dict, dict, float]:
...
def review_cards(state: StudentState) -> dict:
    ...
    if stage == "light":
        ...
        reviewed, sk, cost = review_object(state, obj, "career cards", role="skeptic", batch=12)
