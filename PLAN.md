...
- **Persona caveat:** there is no "Product Manager" SOC. O*NET files PM job titles under **11-2021 Marketing Managers** (and some under 15-1252 Software Developers / 13-1111 Management Analysts). Demo as 11-2021 and say so in the UI ("closest official occupation: Marketing Managers") — an honest label is on-brand; a made-up SOC is not. Let the user pick among the 2–3 nearest SOCs at the Ask step.
