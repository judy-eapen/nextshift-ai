...
from .metaculus import metaculus_search; from .exposure import aioe_lookup, anthropic_index, onet_task_diff; from .epoch import epoch_recent; from .occupations import search_occupations
...
for name, res in [
    ...
    ("AIOE", aioe_lookup(soc)), ("Anthropic Index", anthropic_index(soc)), ("O*NET tasks", onet_task_diff(soc)), ("Epoch", epoch_recent()),
]:
